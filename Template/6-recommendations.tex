...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/power_saving_effects.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/battery_lifespan_users.pdf}
...
\subsection{Answer to \textbf{Problem 4}}
    This problem has already been solved in section \ref{sec:recommendations}.