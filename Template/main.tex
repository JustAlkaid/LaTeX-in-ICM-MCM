...
\begin{abstract}
    ...
    extend battery life, it is crucial to understand how these factors affect battery performance. In this paper, we develop a equivalent model to analyze
    and predict the performance of Li-Ion batteries in smartphones under various operating conditions.
