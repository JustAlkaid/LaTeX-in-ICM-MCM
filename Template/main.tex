...
\begin{abstract}
    ...
    from related \textbf{HPPC tests} are used to identify the model parameters. Because the differential equation could not be solved analytically, 
    \textbf{numerical methods} are employed to validate the model, showing logical and intuitive results.
