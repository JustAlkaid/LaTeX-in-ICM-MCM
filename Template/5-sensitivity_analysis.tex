\section{Sensitivity Analysis}
    ...
    \subsection{Numerical Accuracy}
        ...
        a pulse current discharge scenario ($1 \text{A}, 10\text{s}, SoC = 80\%$) to simulate the battery behavior. The results are shown below:
        \begin{figure}[H]
            \centering
        ...
        $\tau_1 = 0.96\text{s}$ and $\tau_2 = 8.84\text{s}$. Therefore, during the 10s discharge pulse, $C_1$ will have a more immediate effect on the 
