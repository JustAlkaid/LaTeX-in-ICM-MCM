\section{Actual Battery}
    ...
    \subsection{Heat Transfer Model in High-Performance Scenarios}
        ...
        if the battery temperature exceeds $50^\circ C$, the device will shutdown to protect the battery. In reality, smartphones often decreases processor
        ...
        It can be observed that high temperature scenarios are quite dangerous for battery operation. Heavy work loads in $30 ^\circ C$ or higher summer
        environment can easily lead to battery overheating.
