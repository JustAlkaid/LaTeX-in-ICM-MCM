...
\noindent
\textbf{Notes:} MAE $= \frac{1}{n}\sum_{i=1}^{n}|y_i - \hat{y}_i|$, RMSE $= \sqrt{\frac{1}{n}\sum_{i=1}^{n}(y_i - \hat{y}_i)^2}$, where $y_i$ and $\hat{y}_i$ denote actual and predicted values.
