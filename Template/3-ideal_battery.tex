    ...
    \subsection{Parameter Estimation}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_R0.png}
                \caption{Internal Resistance $R_0$ vs SoC}
                \label{fig:fitting_R0}
            \end{subfigure}
            \hfill
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_R1.png}
                \caption{Polarization Resistance $R_1$ vs SoC}
            ...
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_R2.png}
                \caption{Polarization Resistance $R_2$ vs SoC}
                \label{fig:fitting_R2}
            \end{subfigure}
            \hfill
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_C1.png}
                \caption{Polarization Capacitance $C_1$ vs SoC}
            ...
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_C2.png}
                \caption{Polarization Capacitance $C_2$ vs SoC}
                \label{fig:fitting_C2}
            \end{subfigure}
            \hfill
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\textwidth]{fitting_OCV.png}
                \caption{Open Circuit Voltage (OCV) vs SoC}
                \label{fig:fitting_OCV}
            \end{subfigure}
            \caption{Parameter Estimation Results for Samsung INR21700 30T Battery}
            \label{fig:parameter_fitting}
        \end{figure}
