\section{Ideal Battery}
    ...
    \subsection{Parameter Estimation}
        The Hybrid Pulse Power Characterization (HPPC) test is commonly used for this purpose~\cite{zhuang2024_hppc}. The test is conducted with steps as follows:
        \begin{enumerate}
